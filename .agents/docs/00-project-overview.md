...
| 用户 | 主要目标 |
| --- | --- |
| 新生/学生 | 使用学校邮箱自助注册，阅读同步的培训文档，接收通知，查看和提交作业，报名并组队参加校内赛，填写问卷，提交系统反馈或问题答疑，浏览已解答的匿名公开答疑，查看私密评语与作业内的优秀作业 |
| 管理员 | 管理异常账号和技术方向分类，手动同步飞书知识库，发布通知和作业，管理校内赛队伍与问卷，处理反馈答疑并使已解答问题匿名公开，给出私密评语，在作业内标记优秀作业并处理审计 |
...
- 登录态反馈答疑工单、学生本人私密记录、已解答问题的匿名只读公开答疑、管理员处理结果和站内提醒。
