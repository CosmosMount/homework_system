...
建设一个单校单组织的新生培训作业与校内赛内部平台。系统负责动态业务流程，并提供飞书培训知识库只读快照同步与登录态阅读；不负责编辑、写回培训知识库，也不承担公开官网功能。
...
- 作业只能由个人提交；当前产品不提供赛事作品提交，独立队伍不拥有提交。若未来恢复赛事作品，仍只能由队伍提交，且只有队长能够创建正式赛事提交版本。
- 不引入评分、排名、自动评奖或公开评语。
...
- 只允许真实管理员手动触发飞书知识库只读快照同步；不得编辑或写回飞书，不得修改或依赖现有官网运行时，失败同步不得覆盖最近成功快照。
